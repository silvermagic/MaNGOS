...
public:
    ...
    void PrintPosError() const
    {
        ...
        sLog.outError(
            "Attempted to %s in ByteBuffer (pos: " SIZEFMTD " size: " SIZEFMTD ") value with size: " SIZEFMTD "%s%s",
...
public:
    ...
    // constructor
    ByteBuffer(MessageBuffer &&buf) : _rpos(0), _wpos(0), _bitpos(8), _curbitval(0), _storage(buf.Move())
    {
    }
